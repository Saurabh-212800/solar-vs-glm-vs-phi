...
- **Windows:**
  ...
  2. Follow the prompts in the installation wizard to complete the process.

- **MacOS:**
  1. Open the `.dmg` file.
  2. Drag the application icon into your Applications folder to install.

- **Linux:**
  1. Extract the downloaded tar file.
  2. Open the terminal and navigate to the folder of the extracted files.
  3. Run the application with the command `./application_name`.

### Step 4: Run the Application
After installation, locate the application in your programs or applications list. Click to open it. You are now ready to start comparing solar data!
...
You will also need at least 4 GB of RAM and 500 MB of free disk space.

## 🌟 Features
Here are some key features of the Solar vs GLM vs Phi application:

- **User-Friendly Interface:** Designed for easy navigation, making your experience seamless.
- **Data Comparison Tools:** Compare different sets of solar data side by side.
- **Graphs and Visuals:** Generate clear graphs to help visualize data.
- **Report Generation:** Create and export detailed reports for further analysis.

## 🛠 Troubleshooting
If you encounter any issues during installation or while using the application, consider the following:

- **Installation Failed:** Ensure you have the correct permissions to install software on your device.
- **Application Not Opening:** Check that your operating system meets the minimum requirements listed above.
